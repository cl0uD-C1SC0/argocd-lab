...
def get_credentials():
    ...
    with open('/mnt/e/Trabalho/GFT/poc-rollout/terraform_outputs', 'r') as file:
    ...
    return argocd_credentials

def start(ARGO_APPS_PATH):
    argocd_credentials = get_credentials()
